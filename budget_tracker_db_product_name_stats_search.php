...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['email']) && isset($_POST['product_name']) && isset($_POST['currency_code']) && isset($_POST['date_from']) && isset($_POST['date_to'])) {
        ...
        $result = productNameStatsList($email, $productName, $currencyCode, $dateFrom, $dateTo);
